const DecorativeData = [
    ...
    
    {
        ...
        otherNames: "French hydrangea, garden hydrangea, and Florist's hydrangea",
        imgURL : "https://drive.google.com/file/d/194VlAPMtf-0D6f8b6VtlybBj9loWlGuP/view?usp=sharing",
        description: "Over 75 species of flowering plants in the genus Hydrangea, sometimes known as Hortensia, are indigenous to Asia and the Americas. From early spring through late autumn, hydrangeas bloom. They often form flowerheads (corymbs or panicles) at the stem ends. Usually, flowerheads have two different kinds of flowers: little, unattractive fertile flowers in the core or interior, and huge, sterile spectacular flowers with brightly colored sepals (tepals). These beautiful flowers are frequently added to the little flowers' exterior or stretched in a ring. The majority of species have white blooms. The colour saturation levels range from the palest of pinks, lavenders, and powder blues to deep, rich purples, bordeaux, and royal blues in some species, most notably H. macrophylla. In others, however, they can be blue, red, or purple. These species' flowers change colour because of the availability of aluminium ions, a factor that is dependent on the pH of the soil.",
        usesAndBenefits : "Hydrangea is a kind of plant. Medicine is made from the root and rhizome (underground stem). Hydrangea is used to treat urinary tract issues such as bladder, urethral, and prostate infections, as well as enlarged prostate and kidney stones. It's also used to treat hay fever. More than 2 grammes of dried hydrangea rhizome/root at a time is LIKELY UNSAFE. It is also UNSAFE to use hydrangea for an extended period of time.",
        howToGrow : "With soil that is porous, moist, and contains some compost, hydrangeas thrive. They can even grow well in some shade because they don't rely heavily on sunlight. They do, however, require some room, particularly if you're planting hydrangeas in clusters. Be sure to space them out between 3 and 5 feet."
    ...
    
    {
        ...
        otherNames: "गुड़हल  in India",
    
        imgURL : "https://drive.google.com/file/d/1-Yda2hbEktY_GcDULTFcJhDOp50N_0Qt/view?usp=sharing",
    
        description: "Hibiscus, commonly called Roselle, belongs to the family Malvaceae. Hibiscus has over 300 species of flowering plants, and one of them is Hibiscus sabdariffa Linne. It is considered a multipurpose plant that may have various health benefits. Hibiscus is a perennial flowering plant grown throughout the seasons. The shrub originated in Africa and is planted worldwide in tropical and subtropical regions of India, China, Sudan, Malaysia, Taiwan and many other countries. A Hibiscus plant will add immeasurable beauty to any home garden, with its array of colors giving out fragrances that are enticing and alluring. They bring rightness and glamor to a home, whether inside the house or outside in the garden. Hibiscus is cultivated for flowers, leaves, stems, seeds and roots. Hibiscus flowers and seed oils are widely used in food, cosmetic, and pharmaceutical formulations. Hibiscus has medicinal value, which has been referenced in Ayurveda and the Chinese medicine system. It is commonly called Lalambari or Gudhal in Hindi and Jaswandh in Marathi.",
    
        usesAndBenefits : "It may have antiseptic properties, anti-spasmodic properties (relieves muscle spasms), blood pressure-lowering properties, mild laxative effect (help constipation),  diuretic effect (increase urine production), antioxidant activity, anti-cancer activity, antipyretic effect (reduce fever), sedative properties, blood sugar-lowering properties.",
        howToGrow : "The hibiscus usually grows in tropical conditions, it needs ample amount of sunlight. Temperatures ranging between 16°C – 32°C are most optimum.What you need to keep in mind while watering your hibiscus are the weather and the flowering cycle. In the flowering stage, the hibiscus requires more water. During summers as well, it needs a fair bit of watering but not too much so as to drown the plant.Finally, in the winter, water only when you feel that the soil has gone dry.",
